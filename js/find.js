...
const porthole = document.getElementById("portal");
let portal = document.getElementById("porthole");
...
const update_link = (link) => {
    ...
    if (link.contains("/music/")) {
        portal = document.createElement("audio");
        portal.controls = true;
        portal.autoplay = true;
...
update_link("http://ehpt.org/bwsjs/music/anita/leavemealone.mp3");